<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="staff_login.aspx.cs" Inherits="Attendance_final.staff_login" %>
...
<div id="main" style="background-image:url(Image/2.jpg);">
    <div id="center">
        ...
        <br />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/stf_forgate.aspx">Forgate Password?</asp:HyperLink>
        <br /><br />
